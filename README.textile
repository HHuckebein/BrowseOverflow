...
http://www.amazon.com/gp/product/0321774183/ref=as_li_ss_tl?ie=UTF8&camp=1789&creative=390957&creativeASIN=0321774183&linkCode=as2&tag=qualitycoding-20
...
As Graham pointed out on page 199 the app doesn't work as one might expect. If you browse the same topic twice you find the same questions added again to the list.
At least this problem can be easily solved by adding only questions to the recentQuestions array if they are not already part of by examining the questionID.
...
plus extending the Question class with
